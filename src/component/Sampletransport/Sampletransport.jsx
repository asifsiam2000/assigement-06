      ...
      <div className="text-center my-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 h-full">
            ...
            <div className="card  bg-base-300 shadow-sm space-y-3 p-6 h-full">
                  ...
                  <div>
                      <h2 className="text-2xl font-bold">$0 <span className="text-xl font-light"> /Month</span></h2>
                  </div>
              ...
              <div className="card  bg-base-300 shadow-sm space-y-3 p-6 h-full">
                  ...
                  <div>
                      <h2 className="text-2xl font-bold">$99 <span className="text-xl font-light"> /Month</span></h2>
                  </div>
